...
export type GenerativeUIConfig = {
    /**
     * The DOM element or CSS selector where the UI components will be rendered.
     * Required.
     */
    container: string | HTMLElement;
    /**
     * An optional `Transport` instance or `TransportOptions` to configure a new transport.
     * This establishes communication with a backend service (e.g., WebSocket, SSE).
     */
    transport?: Transport | TransportOptions;
    /**
     * If true, clears the content of the `container` element before the first render.
     * Defaults to `true`.
     */
    clearContainer?: boolean;
    /**
     * If `true`, enables local browser persistence (using `localStorage`) for conversation history.
     * Defaults to `false`.
     */
    enableLocalPersistence?: boolean;
    /**
     * Optional callback function for handling general errors originating from the UI library
     * (e.g., JSON parsing failures, component application errors).
     * @param error The error object.
     * @param context Optional raw data or context related to the error.
     */
    onError?: (error: unknown, context?: string) => void;
    /**
     * Optional callback function invoked when the transport connection is successfully established.
     * @param connection The active `Transport` instance.
     */
    onOpen?: (connection: Transport) => void;
    /**
     * Optional callback function invoked when the transport connection is gracefully closed or lost.
     */
    onClose?: () => void;
};
